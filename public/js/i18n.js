const dict = {
    ru: {
        ...
        "hero.subtitle": "Веду фичи end-to-end: от архитектуры и API до релиза, аналитики и поддержки пользователей.",
        "about.title": "Обо мне",
        "about.stackTitle": "Стек",
        "about.stackText": "React, TypeScript (strict), Next.js, Node.js, PostgreSQL, Redis, BigQuery, Docker.",
        "about.expTitle": "Опыт",
        "about.expText": "Коммерческая разработка frontend/fullstack, high-load сценарии, интеграции и поддержка production.",
    ...
    en: {
        ...
        "hero.subtitle": "I deliver end-to-end features from architecture and API to release, analytics and support.",
        "about.title": "About",
        "about.stackTitle": "Stack",
        "about.stackText": "React, TypeScript (strict), Next.js, Node.js, PostgreSQL, Redis, BigQuery, Docker.",
        "about.expTitle": "Experience",
        "about.expText": "Commercial frontend/fullstack development, high-load scenarios, integrations and production support.",
